    ...
    <div>
      ...
      <form id="checkout-form">
        ...
        <div class="option-group">
          <label class="option-item"><input type="radio" name="delivery" value="zasilkovna_adresa" checked><span>Zásilkovna – doručení na adresu</span></label>
          <label class="option-item"><input type="radio" name="delivery" value="zasilkovna_vydejni"><span>Zásilkovna – výdejní místo</span></label>
          <label class="option-item"><input type="radio" name="delivery" value="zasilkovna_zbox"><span>Zásilkovna – Z-BOX</span></label>
          <label class="option-item"><input type="radio" name="delivery" value="ceska_posta"><span>Česká pošta</span></label>
          <label class="option-item"><input type="radio" name="delivery" value="osobni"><span>Osobní vyzvednutí</span></label>
        </div>
        ...
        <div class="option-group">
          <label class="option-item"><input type="radio" name="payment" value="online" checked><span>Online platba kartou / Google Pay</span></label>
          <label class="option-item"><input type="radio" name="payment" value="dobirka"><span>Dobírka</span></label>
          <label class="option-item"><input type="radio" name="payment" value="prevodem"><span>Platba předem na účet</span></label>
        </div>
